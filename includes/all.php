...
function head($css_list) {
    ...
    <head>
        ...
        <link rel='icon' href='/CrimsonHacks/img/mars-favicon.png' type='image/x-icon'>
...
<nav class='navbar'>
    ...
    <ul>
        ...
        <div class='navbar-social'><li><a href='https://youtu.be/oHg5SJYRHA0'>Karls Mars Party</a></li></div>
    </ul>   
</nav>
";
}
